...
> Condensed to **1,911 chars** to fit arXiv's 1,920-char metadata limit. The PDF's full abstract (in `paper/main.tex`) is unchanged — arXiv only caps the *metadata* field, not the paper.
