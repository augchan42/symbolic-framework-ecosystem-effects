...
- [ ] **Cross-list:** cs.AI, cs.LG
- [ ] **License:** CC BY 4.0
- [ ] **Comments field:** e.g., `26 pages, 3 figures, 9 tables, 6 listings`. **This is a replacement of arXiv:2606.07552 (v2), not a new submission** — upload via "replace," keep the same identifier; the v2 author corrections and N=61 reframe ride along.
